# Ansibleコレクション `fsas_temp_ns.primergy` 設定ガイド
...
このドキュメントはAnsibleコレクション`fsas_temp_ns.primergy`で提供している各ロールの利用方法を、
プレイブックの例を添えて説明します。  
...
4. 右記OSに関連した情報を表示する: No Operating System Dependencies
5. ドキュメント > User Guide > iRMC S6 - Web インターフェース 3.x > ダウンロード
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/irmc_update_irmc/>
  を参照してください。
  ...
  roles:
    - role: fsas_temp_ns.primergy.irmc_update_irmc
      vars:
        ...
        irmc_firmware_path: "RX1330_M6/irmc/PRIMERGYTX13x0M6iRMC264SSDR851リモートアップデートツ_D41320264Ssdr0851_1312819.BIN"
        destination: low
```
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/irmc_update_bios/>
  を参照してください。
- 異なる機種に同時適用するような場合は、それぞれの機種に応じたファームウェアを指定する必要があります。
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/irmc_set_certificate/>
  を参照してください。
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/irmc_snmp/>
  を参照してください。
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/irmc_email_alert/>
  を参照してください。
- 変更不要なパラメタは記述しなくて構いません。
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/irmc_account_admin/>
  を参照してください。
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/irmc_set_ntp/>
  を参照してください。
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/irmc_set_license/>
  を参照してください。
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/win_data_drive/>
  を参照してください。
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/win_organization_owner/>
  を参照してください。
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/win_hostname/>
  を参照してください。
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/win_locale/>
  を参照してください。
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/win_dns/>
  を参照してください。
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/win_set_membership/>
  を参照してください。
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/win_snmp/>
  を参照してください。
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/win_set_rdp/>
  を参照してください。
...
6. `ServerViewAgentsforWindows_<version>_*.exe`を実行して展開する
7. `ServerView\Agents\ServerViewAgents_Win_x64.exe`を取り出す

- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/win_serverview_agents/>
  を参照してください。
...
6. `ServerViewRAIDManagerWindows64bit_<version>_*.zip`を展開する
...
- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/win_serverview_raidmanager/>
  を参照してください。
...
7. `ServerViewManagementandServiceabilityDVD_*.zip`ファイルを展開し、isoファイルを取り出す

- パラメタなどの詳細については
  <https://galaxy.ansible.com/ui/repo/published/fsas_temp_ns/primergy/content/role/win_dsnap/>
  を参照してください。
