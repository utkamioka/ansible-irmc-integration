...
- name: Get and show Bios Boot Order
  ...
  block:
    - name: Get Bios Boot Order
      fsas.primergy.irmc_biosbootorder:
...
from ansible_collections.fsas.primergy.plugins.module_utils.irmc import (
    get_irmc_json,
    irmc_redfish_delete,
    irmc_redfish_get,
    irmc_redfish_post,
...
from ansible_collections.fsas.primergy.plugins.module_utils.irmc_utils import compare_irmc_profile
